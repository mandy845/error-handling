...
lbluser = Label(frame, text=" Username")
...
reset_btn = Button(frame, text='clear', bg='pink', command=clear_entry)
reset_btn.grid(row=5, column=3, pady=5)

exit_btn = Button(frame, text='Exit', bg='pink', command=exit)
exit_btn.grid(row=5, column=1, pady=5)

cal_btn = Button(frame, text='log in', bg='pink', command=verify)
